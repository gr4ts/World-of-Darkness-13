...
//	minimal_generation = 11	//Uncomment when players get exp enough
	...
	allowed_bloodlines = list("Daughters of Cacophony", "Caitiff", "Banu Haqim", "Baali", "True Brujah", "Brujah", "Nosferatu", "Gangrel", "Toreador", "Malkavian", "Ventrue", "Lasombra", "Gargoyle", "Ministry")
